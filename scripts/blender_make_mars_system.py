...
# Blender 3.x+ — Mars system animado (GLB)
import bpy, math
def clear_scene():
    bpy.ops.object.select_all(action='SELECT'); bpy.ops.object.delete(use_global=False)
def create_uv_sphere(name, r, seg=64, rings=32, color=(0.76,0.33,0.22,1)):
...
if __name__=="__main__": main(); print("Exporte como GLB (File > Export > glTF 2.0) → models/mars_system.glb")
